...
export default function MediaSection() {
    // Featured item (first with an image if any)
    const featured = MEDIA_COVERAGE.find(m => m.image);
    const others = MEDIA_COVERAGE.filter(m => m !== featured);

    return (
        <section id="media" className="bg-[#0a0d1a] py-24 relative overflow-hidden">
            <div className="container-custom">
                ...
                <div className="mb-14">
                    <p className="font-mono text-[0.72rem] font-medium text-primary-light tracking-widest uppercase mb-3 flex items-center gap-3">
                        <span className="w-10 h-px bg-primary-light/50" /> Public Presence
                    </p>
                    <h2 className="text-[clamp(2rem,4vw,3rem)] font-extrabold mb-3 text-white">
                        Press & <span className="gradient-text">Media</span>
                    </h2>
                    <p className="text-white/50 max-w-[560px] text-sm leading-relaxed">
                        Media highlights, interviews, and features on disability and technology research.
                    </p>
                </div>
