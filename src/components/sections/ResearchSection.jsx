...
export default function ResearchSection() {
    return (
        <section id="research" className="bg-[#070B14] py-24 relative overflow-hidden">
            <div className="container-custom">
                ...
                <div className="mb-16 max-w-[640px]">
                    <p className="font-mono text-[0.72rem] font-medium text-primary-light tracking-widest uppercase mb-3 flex items-center gap-3">
                        <span className="w-10 h-px bg-primary-light/50" /> Research Focus
                    </p>
                    <h2 className="text-[clamp(2rem,4vw,3rem)] font-extrabold mb-4 text-white">
                        Areas of <span className="gradient-text">Investigation</span>
                    </h2>
                    <p className="text-white/50 text-sm leading-relaxed">
                        Research sits at the crossroads of science & technology policy, disability studies, and intellectual property — seeking to make technology more accessible and equitable.
                    </p>
                </div>

                {/* Research area cards — now a 2x2 grid, each with a top accent bar */}
                ...
                {/* Current PhD Research — image background callout */}
